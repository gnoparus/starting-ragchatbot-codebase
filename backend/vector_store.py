...
class VectorStore:
        ...
        metadatas = [
            {
                ...
                "lesson_number": (
                    chunk.lesson_number if chunk.lesson_number is not None else -1
                ),  # Convert None to -1
    ...
    def get_existing_course_titles(self) -> List[str]:
        ...
        try:
            ...
            log.error(
                f"Error getting existing course titles",
                error=str(e),
                error_type=type(e).__name__,
            )
            return []
    ...
    def get_course_count(self) -> int:
        ...
        try:
            ...
            log.error(
                f"Error getting course count", error=str(e), error_type=type(e).__name__
            )
            return 0
    ...
    def get_all_courses_metadata(self) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            log.error(
                f"Error getting courses metadata",
                error=str(e),
                error_type=type(e).__name__,
            )
            return []
