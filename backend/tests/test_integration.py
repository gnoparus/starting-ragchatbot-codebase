...
class TestRAGIntegration:
    ...
    def test_api_query_with_session(self, mock_rag_system):
        ...
        mock_rag_system.query.return_value = ("Follow-up answer with context", [])
        ...
        mock_rag_system.query.assert_called_once_with(
            "Tell me more about that", "existing_session_456"
        )
    ...
    def test_complete_rag_flow_with_real_components(
        self, test_config, temp_chroma_dir, test_course_document
    ):
        ...
        try:
            ...
            with patch("ai_generator.anthropic.Anthropic") as mock_anthropic:
                ...
                mock_final_response.content = [
                    Mock(
                        text="Based on the course content, the introduction covers basic concepts."
                    )
                ]
                ...
                assert (
                    response
                    == "Based on the course content, the introduction covers basic concepts."
                )
    ...
    def test_search_tool_integration_with_vector_store(
        self, test_config, temp_chroma_dir, sample_course, sample_course_chunks
    ):
    ...
    def test_ai_generator_tool_calling_integration(self, test_config):
        ...
        with patch("ai_generator.anthropic.Anthropic") as mock_anthropic:
            ...
            mock_final_response = Mock()
            mock_final_response.content = [
                Mock(text="Here's the answer based on search results")
            ]
            ...
            mock_store.search.assert_called_once_with(
                query="test search", course_name=None, lesson_number=None
            )
    ...
    def test_max_results_zero_issue_simulation(self, test_config, temp_chroma_dir):
        ...
        assert "Search error:" in result and (
            "cannot be negative, or zero" in result
