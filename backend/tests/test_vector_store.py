...
class TestVectorStore:
    ...
    def test_initialization(self, mock_embedding_fn, mock_client, temp_chroma_dir):
        ...
        mock_client.assert_called_once_with(
            ...
            settings=mock_client.call_args[1]['settings']
        )
    ...
    @patch('vector_store.chromadb.PersistentClient')
    @patch('vector_store.chromadb.utils.embedding_functions.SentenceTransformerEmbeddingFunction')
    def test_search_without_filters(self, mock_embedding_fn, mock_client, temp_chroma_dir):
        """Test search without course name or lesson filters"""
        mock_client_instance = Mock()
        mock_client.return_value = mock_client_instance
        
        mock_content_collection = Mock()
        mock_client_instance.get_or_create_collection.side_effect = [Mock(), mock_content_collection]
    ...
    @patch('vector_store.chromadb.PersistentClient')
    @patch('vector_store.chromadb.utils.embedding_functions.SentenceTransformerEmbeddingFunction')
    def test_search_with_course_filter(self, mock_embedding_fn, mock_client, temp_chroma_dir):
        ...
        mock_client_instance.get_or_create_collection.side_effect = [
            mock_catalog_collection, mock_content_collection
        ]
    ...
    @patch('vector_store.chromadb.PersistentClient')
    @patch('vector_store.chromadb.utils.embedding_functions.SentenceTransformerEmbeddingFunction')
    def test_search_with_lesson_filter(self, mock_embedding_fn, mock_client, temp_chroma_dir):
    ...
    @patch('vector_store.chromadb.PersistentClient')
    @patch('vector_store.chromadb.utils.embedding_functions.SentenceTransformerEmbeddingFunction')
    def test_search_with_both_filters(self, mock_embedding_fn, mock_client, temp_chroma_dir):
    ...
    @patch('vector_store.chromadb.PersistentClient')
    @patch('vector_store.chromadb.utils.embedding_functions.SentenceTransformerEmbeddingFunction')
    def test_search_course_not_found(self, mock_embedding_fn, mock_client, temp_chroma_dir):
        """Test search when course name cannot be resolved"""
        mock_client_instance = Mock()
        mock_client.return_value = mock_client_instance
        
        mock_catalog_collection = Mock()
        mock_client_instance.get_or_create_collection.side_effect = [mock_catalog_collection, Mock()]
    ...
    @patch('vector_store.chromadb.PersistentClient')
    @patch('vector_store.chromadb.utils.embedding_functions.SentenceTransformerEmbeddingFunction')
    def test_search_error_handling(self, mock_embedding_fn, mock_client, temp_chroma_dir):
    ...
    @patch('vector_store.chromadb.PersistentClient')
    @patch('vector_store.chromadb.utils.embedding_functions.SentenceTransformerEmbeddingFunction')
    def test_add_course_metadata(self, mock_embedding_fn, mock_client, temp_chroma_dir, sample_course):
    ...
    @patch('vector_store.chromadb.PersistentClient')
    @patch('vector_store.chromadb.utils.embedding_functions.SentenceTransformerEmbeddingFunction')
    def test_add_course_content(self, mock_embedding_fn, mock_client, temp_chroma_dir, sample_course_chunks):
    ...
    @patch('vector_store.chromadb.PersistentClient')
    @patch('vector_store.chromadb.utils.embedding_functions.SentenceTransformerEmbeddingFunction')
    def test_add_empty_course_content(self, mock_embedding_fn, mock_client, temp_chroma_dir):
    ...
    @patch('vector_store.chromadb.PersistentClient')
    @patch('vector_store.chromadb.utils.embedding_functions.SentenceTransformerEmbeddingFunction')
    def test_get_existing_course_titles(self, mock_embedding_fn, mock_client, temp_chroma_dir):
